...
class FrontEnd(QMainWindow):
	...
	def widget(self):
		...
		tt_mgsub_btw.setIcon( self.tool.image( plib.get(2) ) )
		...
		tt_conform_btw.setIcon( self.tool.image( plib.get(4) ) )
		...
		tt_mail_btw.setIcon( self.tool.image( plib.get(3) ) )
		...
		tt_qr_btw.setIcon( self.tool.image( plib.get(7) ) )
		...
		tt_pdf_btw.setIcon( self.tool.image( plib.get(9) ) )
		...
		tr_conform_btw.setIcon( self.tool.image( plib.get(4) ) )
		...
		tr_dtable_btw.setIcon( self.tool.image( plib.get(1) ) )
		...
		tr_pdf_btw.setIcon( self.tool.image( plib.get(9) ) )
		...
		tr_search_btw.setIcon( self.tool.image( plib.get(6) ) )
		...
		tr_add_btw.setIcon( self.tool.image( plib.get(10) ) )
