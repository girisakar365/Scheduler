...
class DataGen:
    ...
    def gen_data(limit:int=27):
        name = ['Uttam Raj','Ram','Shyam', "Hari", 'Samip', 'Varun', 'Bardan' ,
                ...
                'Uttam','Ankit','Pratik','Lexie','Leslie','Jill',
                'Eilen','Jonathan','Jane','David','Ann','Sheila','Simon']
        ...
        sname=['Bhusal','Arayal','Galwali','Arayal','Ghimire','Shrestha', 'Ghimire','Sharma','Acharya', 'Giri', 'Nepal', 'Kharel','Kadel',
            ...
            'Maharjan', 'Anderson','Austin','Baker','Barlett','Barrow','Begum','Blackmore','Boughton','Brown','Burrell','Carroll','Chapman'
            ,'Cheung']
        ...
        for i in range(limit):
            ...
            subject=choice(['Physics','Chemistry','Maths','Computer','Biology','English','Nepali'])
